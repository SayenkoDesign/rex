...
function get_svg( $type = '' ) {
	...
	$svgs = array(      
        ...
        'menu-icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="38" height="34" class="menu-icon" viewBox="0 0 38 34"><g fill="none" fill-rule="evenodd" stroke="#252B33" stroke-width="3" stroke-linecap="square"><path d="M2 22h34M2 12h34M2 32h27M2 2h27"/></g><span class="screen-reader-text">menu icon</span></svg>',
        
        'phone-mobile' => '<svg width="38" height="38" xmlns="http://www.w3.org/2000/svg"><path d="M38 29.407v1.718c-.516 3.797-4.293 6.81-8.975 6.874-3.353.046-7.312-1.772-10.502-3.437C9.884 30.054 1.879 20.365 0 10.312V8.021C1.128 3.675 2.848-.08 8.402 0c1.325 1.278 1.91 2.678 2.864 4.392.692 1.243 2.545 3.586 2.483 4.774-.145 2.78-4.582 3.229-4.774 5.537-.108 1.301 1.719 3.667 2.482 4.774.971 1.408 2.15 2.925 3.247 4.01 1.226 1.213 6.583 5.81 8.783 5.537 2.045-.255 2.963-4.65 5.347-4.774.998-.052 3.143 1.49 4.583 2.291 1.88 1.047 3.676 2.106 4.583 2.865" fill="#008F4D" fill-rule="evenodd"/></svg>',
